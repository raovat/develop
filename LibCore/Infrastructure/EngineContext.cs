...
namespace LibCore.Infrastructure
{
    ...
    public class EngineContext
    {
        ...
        public static IEngine Initialize(bool forceRecreate)
        {
            ...
            {
                var config = ConfigurationManager.GetSection("SysproConfig") as SysproConfig;
        ...
        public static IEngine CreateEngineInstance(SysproConfig config)
        {
